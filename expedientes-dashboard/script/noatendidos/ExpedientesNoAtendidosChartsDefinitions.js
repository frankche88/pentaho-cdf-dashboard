...
TableDefinition = {
    atendidosVsNoAtendidos: {
        ...
        "drawCallback" : function( component){
            ...
            $('#tableAtendidosVsNoAtendidosTable > tbody:first').append('<tr><td class="column0 string" style="text-width:bold">Total</td><td class="column1 numeric">' +iTotalNoAtendidos + '</td><td class="column2 numeric">' + iTotalAtendidos+ '</td><td class="column3 numeric">' + iTotalExpedientes+ '</td></tr>');
        }
    },
    porFlujoAtendidos: {
        ...
        "drawCallback" : function( component){
            ...
            $('#tablePorFlujoAtendidosTable > tbody:first').append('<tr><td class="column0 string" style="text-width:bold">Total</td><td class="column1 numeric">' +iTotalExpedientes + '</td></tr>');
        }
    },
    porFlujoNoAtendidos: {
        ...
        "drawCallback" : function( component){
            ...
            $('#tablePorFlujoNoAtendidosTable > tbody:first').append('<tr><td class="column0 string" style="text-width:bold">Total</td><td class="column1 numeric">' +iTotalExpedientes + '</td></tr>');
        }
    }
}
