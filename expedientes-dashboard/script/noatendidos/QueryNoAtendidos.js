...
QueryTable = {
	...
	porRemitenteNoAtendidos : function(filtersObject) {
		...
		var query = " SELECT    NOMBRE, ATENDIDOS, PORCENTAJE  "
				...
				+ "             ) order by 2	  ";
		console.log("tabla porRemitenteNoAtendidos: " + query);
		return query;
	},
	porRemitenteAtendidos : function(filtersObject) {
		...
		var query = " SELECT    NOMBRE, ATENDIDOS, ROUND((ATENDIDOS/DECODE(TOTAL,0,1,TOTAL))*100,0) AS PORCENTAJE  "
				...
				+ "                         GROUP BY UNID2.NOMBRE, ESTADO "
				+ "                  ) order by 2";
		console.log("tabla porRemitenteAtendidos: " + query);
		return query;
	}
}
...
QueryPiechart = {
	porRemitenteNoAtendidos : function(filtersObject) {
		...
		var query = " SELECT    NOMBRE, ATENDIDOS, PORCENTAJE  "
				...
				+ "                         GROUP BY UNID2.NOMBRE, ESTADO "
				+ "             ) order by 2	  ";
		console.log("piechart porRemitenteNoAtendidos: " + query);
		return query;
	},
	porRemitenteAtendidos : function(filtersObject) {
		var filters = QueryFilters.createFilters(filtersObject);
		var query = " SELECT    NOMBRE, ATENDIDOS, PORCENTAJE  "
				...
				+ "                         GROUP BY UNID2.NOMBRE, ESTADO "
				+ "                  ) order by 2";
		console.log("piechart porRemitenteAtendidos: " + query);
		return query;
	}
}
	...
	createFilters : function(filtersObject) {
		...
		if (filtersObject) {
			...
			if (filtersObject.startDate != "") {
				consulta += " AND EXPE.FECHACREACION BETWEEN TO_DATE ('"
