...
TableDefinitions = {
    ...
    enumerados: {
        ...
        jndi: constants.JNDI,
        query: function() { 
            var query = FirmadosQuery.tableEnumerados(parameters);
            //console.log(query);
            return query;
        },
        ...
        "drawCallback" : function( component){
            ...
            $('#tableEnumeradosTable > tbody:first').append('<tr><td class="column0 string" style="text-width:bold">Total</td><td class="column1 numeric">' +iTotalNoAtendidos + '</td><td class="column2 numeric">' + iTotalAtendidos+ '</td><td class="column3 numeric">' + iTotalExpedientes+ '</td></tr>');
        }
    },
    firmados: {
        ...
        jndi: constants.JNDI,
        query: function() { 
            var query = FirmadosQuery.tableFirmados(parameters);
            return query;
        },
        oLanguage : Tables.oLanguage,
        "drawCallback" : function( component){
            ...
            $('#tableFirmadosTable > tbody:first').append('<tr><td class="column0 string" style="text-width:bold">Total</td><td class="column1 numeric">' +iTotalNoAtendidos + '</td><td class="column2 numeric">' + iTotalAtendidos+ '</td><td class="column3 numeric">' + iTotalExpedientes+ '</td></tr>');
        }
    },
    enumeradosFirmados: {
        colHeaders: ["Unidad","No Enumerados","Enumerados", "total"],
        ...
        jndi: constants.JNDI,
        query: function() { 
            var query = FirmadosQuery.tableEnumeradosFirmados(parameters);
            return query;
        },
        oLanguage : Tables.oLanguage,
        "drawCallback" : function( component){
            ...
            $('#tableEnumeradosFirmadosTable > tbody:first').append('<tr><td class="column0 string" style="text-width:bold">Total</td><td class="column1 numeric">' +iTotalNoAtendidos + '</td><td class="column2 numeric">' + iTotalAtendidos+ '</td><td class="column3 numeric">' + iTotalExpedientes+ '</td></tr>');
        }
    },
...
//Protovis chart
    enumerados: {
        ...
        extensionPoints: [["barLabel_text",function(d){return ' ' + d + '%'}],["titleLabel_font","18px sans-serif"],["yAxisRule_lineWidth", 0],["bar_fillStyle", function(s){ 
            var serie = this.datum().elem.series.value;
            return barcharColor.colorSelector(serie);}
            ],["legendDot_fillStyle", function(serie){ return barcharColor.colorSelector(serie);}],["legendDot_strokeStyle", function(serie){ return barcharColor.colorSelector(serie);}]],
        jndi: constants.JNDI,
        queryType: 'sql',
		query: function() { 
            var query = FirmadosQuery.chartEnumerados(parameters);
            //console.log(query);
            return query;
        }
    },
    firmados: {
        ...
        queryType: 'sql',
		query: function() { 
            var query = FirmadosQuery.chartFirmados(parameters);
            return query;
        }
    },
    enumeradosFirmados: {
        ...
        queryType: 'sql',
		query: function() { 
            var query = FirmadosQuery.chartEnumeradosFirmados(parameters);
            //console.log(query);
            return query;
        }
    }
